...
<section id="About-header" class="section-p1">
    <div class="content-container">
        ...
        <div class="about-content">
            <h2>About Us</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit, placeat illo quod asperiores, nemo
                blanditiis quasi labore ullam tempora unde dicta excepturi repudiandae voluptates obcaecati laborum
                aperiam error, sint esse?</p>
            <abbr title="">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aliquam repellendus id asperiores
                ab enim eius.</abbr>
            <br><br>
            <marquee bgcolor="#ccc" loop="-1" scrollamount="5" width="100%">Lorem ipsum, dolor sit amet consectetur
                adipisicing elit. Neque blanditiis vitae quibusdam harum ipsum. Atque!
            </marquee>
        </div>
    </div>
</section>
